# markdown content namespace: nb_libs readme 
...
# markdown content namespace: nb_libs codes 
...
└── nb_libs
    ...
    │   ├── nbic.py
    │   ├── redis_key.py
    │   ├── smart_serialization.py
    │   └── smart_serialization0001.py
    └── tools
        ├── auto_git.py
        ├── code_line_statistics.py
        ├── codes2_md.py
        ├── github_git_clone.py
        ├── markdown2pdf.py
        └── memory_leak_analysis.py
...
- `nb_libs/dict_util.py`

- `nb_libs/env_util.py`

- `nb_libs/global_dict.py`

- `nb_libs/http_util.py`
...
- `nb_libs/platforms.py`

- `nb_libs/pydantic_helper.py`

- `nb_libs/restart_programe.py`

- `nb_libs/str_utils.py`

- `nb_libs/sys_frame_uitils.py`

- `nb_libs/__init__.py`

- `nb_libs/temps/nbic.py`

- `nb_libs/temps/redis_key.py`

- `nb_libs/temps/smart_serialization.py`

- `nb_libs/temps/smart_serialization0001.py`

- `nb_libs/tools/auto_git.py`

- `nb_libs/tools/codes2_md.py`

- `nb_libs/tools/code_line_statistics.py`

- `nb_libs/tools/github_git_clone.py`

- `nb_libs/tools/markdown2pdf.py`

- `nb_libs/tools/memory_leak_analysis.py`


---


### code file start: nb_libs/aio_util.py 
...
**code file end: nb_libs/aio_util.py**

---


### code file start: nb_libs/dict_util.py 
...
**code file end: nb_libs/dict_util.py**

---


### code file start: nb_libs/env_util.py 
...
**code file end: nb_libs/env_util.py**

---


### code file start: nb_libs/global_dict.py 
...
**code file end: nb_libs/global_dict.py**

---


### code file start: nb_libs/http_util.py 
...
**code file end: nb_libs/http_util.py**

---


### code file start: nb_libs/lazy_importer.py 
...
**code file end: nb_libs/lazy_importer.py**

---


### code file start: nb_libs/nb_time.py 

```python
from nb_time import *
```

**code file end: nb_libs/nb_time.py**

---


### code file start: nb_libs/path_helper.py 
...
**code file end: nb_libs/path_helper.py**

---


### code file start: nb_libs/platforms.py 
...
**code file end: nb_libs/platforms.py**

---


### code file start: nb_libs/pydantic_helper.py 
...
**code file end: nb_libs/pydantic_helper.py**

---


### code file start: nb_libs/restart_programe.py 
...
**code file end: nb_libs/restart_programe.py**

---


### code file start: nb_libs/str_utils.py 
...
**code file end: nb_libs/str_utils.py**

---


### code file start: nb_libs/sys_frame_uitils.py 
...
**code file end: nb_libs/sys_frame_uitils.py**

---


### code file start: nb_libs/__init__.py 

```python

```

**code file end: nb_libs/__init__.py**

---


### code file start: nb_libs/temps/nbic.py 
...
**code file end: nb_libs/temps/nbic.py**

---


### code file start: nb_libs/temps/redis_key.py 
...
**code file end: nb_libs/temps/redis_key.py**

---


### code file start: nb_libs/temps/smart_serialization.py 
...
**code file end: nb_libs/temps/smart_serialization.py**

---


### code file start: nb_libs/temps/smart_serialization0001.py 
...
**code file end: nb_libs/temps/smart_serialization0001.py**

---


### code file start: nb_libs/tools/auto_git.py 
...
**code file end: nb_libs/tools/auto_git.py**

---


### code file start: nb_libs/tools/codes2_md.py 
...
**code file end: nb_libs/tools/codes2_md.py**

---


### code file start: nb_libs/tools/code_line_statistics.py 
...
**code file end: nb_libs/tools/code_line_statistics.py**

---


### code file start: nb_libs/tools/github_git_clone.py 
...
**code file end: nb_libs/tools/github_git_clone.py**

---


### code file start: nb_libs/tools/markdown2pdf.py 
...
**code file end: nb_libs/tools/markdown2pdf.py**

---


### code file start: nb_libs/tools/memory_leak_analysis.py 
...
**code file end: nb_libs/tools/memory_leak_analysis.py**
