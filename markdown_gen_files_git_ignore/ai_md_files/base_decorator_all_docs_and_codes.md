# markdown content namespace: base_decorator readme 
...
# markdown content namespace: base_decorator codes 
...
- `base_decorator/__init__.py`


---


### code file start: base_decorator/__init__.py 
...
**code file end: base_decorator/__init__.py**
