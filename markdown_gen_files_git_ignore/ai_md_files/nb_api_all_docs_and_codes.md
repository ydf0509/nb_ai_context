# markdown content namespace: nb_api project summary 
...
### the project nb_api most core source code files as follows: 
- `nb_api/core/aio_sqlmodel.py`
- `nb_api/core/base.py`


### 📄 Python File Metadata: `nb_api/core/aio_sqlmodel.py`
...
- `from types import CALLABLE_LIST`
...
### 📄 Python File Metadata: `nb_api/core/base.py`
...
- `from types import T`
- `from types import DEPENDENCIES`
- `from types import ErrorResponseModel`
- `from types import ResponseModel`
...
- `def remove_api_route(self, path: str, methods: List[str]) -> None`
  - *移除 API 路由*
- `def get_routes() -> List[str]` `staticmethod`
  - *获取所有路由名称*
...
# markdown content namespace: nb_api Project Root Dir Some Files 
...
# 核心用法！
app.include_router(
    SQLModelCRUDRouter(schema=Book, db_model=Book, db=get_session)
)
```
...
- `nb_api/core/sqlalchemy.py`

- `nb_api/core/sqlmodel.py`

- `nb_api/core/tortoise.py`
...
--- **start of file: nb_api/__init__.py** --- 


### 📄 Python File Metadata: `nb_api/__init__.py`

#### 📝 Module Docstring

```
nb_api - 基于 FastAPI + Pydantic v2 + 各种流行ORM  的自动 CRUD 路由生成框架
支持的 ORM 包括 sqlmodel sqlalchemy tortoise memory内存 等
```
...
--- **end of file: nb_api/__init__.py** --- 

---


--- **start of file: nb_api/contrib/fastapi_helpers.py** --- 


### 📄 Python File Metadata: `nb_api/contrib/fastapi_helpers.py`
...
- `def add_slow_request_logger(app: FastAPI, logger: logging.Logger) -> None`
  - *Line: 11*
...
- `async def slow_request_middleware(request: Request, call_next)` `app.middleware('http')`
  - *Line: 34*
...
--- **end of file: nb_api/contrib/fastapi_helpers.py** --- 

---


--- **start of file: nb_api/contrib/__init__.py** --- 


### 📄 Python File Metadata: `nb_api/contrib/__init__.py`
...
--- **end of file: nb_api/contrib/__init__.py** --- 

---


--- **start of file: nb_api/core/aio_sqlmodel.py** --- 
...
class AioSQLModelCRUDRouter(CRUDGenerator[SCHEMA]):
    ...
    def _delete_all(self, *args: Any, **kwargs: Any) -> CALLABLE_LIST:
        async def route(db: AsyncSession = Depends(self.db_func)) -> ResponseModel[List[Any]]:
            from sqlalchemy import delete
            await db.exec(delete(self.db_model))
            await db.commit()
             # 调用 _get_all() 以确保返回空列表
...
--- **end of file: nb_api/core/aio_sqlmodel.py** --- 

---


--- **start of file: nb_api/core/base.py** --- 
...
--- **end of file: nb_api/core/base.py** --- 

---


--- **start of file: nb_api/core/mem.py** --- 


### 📄 Python File Metadata: `nb_api/core/mem.py`
...
class MemoryCRUDRouter(CRUDGenerator[SCHEMA]):
    ...
    def _delete_all(self, *args: Any, **kwargs: Any) -> CALLABLE_LIST:
        def route() -> ResponseModel[List[SCHEMA]]:
            ...
            _id_counters[self._id_counter_key] = 1
            # 调用 _get_all() 以确保返回空列表
            return self._get_all()(pagination={"skip": 0, "limit": None})
...
--- **end of file: nb_api/core/mem.py** --- 

---


--- **start of file: nb_api/core/sqlalchemy.py** --- 


### 📄 Python File Metadata: `nb_api/core/sqlalchemy.py`
...
--- **end of file: nb_api/core/sqlalchemy.py** --- 

---


--- **start of file: nb_api/core/sqlmodel.py** --- 


### 📄 Python File Metadata: `nb_api/core/sqlmodel.py`
...
--- **end of file: nb_api/core/sqlmodel.py** --- 

---


--- **start of file: nb_api/core/tortoise.py** --- 


### 📄 Python File Metadata: `nb_api/core/tortoise.py`
...
--- **end of file: nb_api/core/tortoise.py** --- 

---


--- **start of file: nb_api/core/types.py** --- 


### 📄 Python File Metadata: `nb_api/core/types.py`
...
--- **end of file: nb_api/core/types.py** --- 

---


--- **start of file: nb_api/core/utils.py** --- 


### 📄 Python File Metadata: `nb_api/core/utils.py`
...
--- **end of file: nb_api/core/utils.py** --- 

---


--- **start of file: nb_api/core/__init__.py** --- 


### 📄 Python File Metadata: `nb_api/core/__init__.py`
...
--- **end of file: nb_api/core/__init__.py** --- 
