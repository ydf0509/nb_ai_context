...
(
    ...
    .add_project_summary(
        ...
        most_core_source_code_file_list=[
            ...
            'nb_cmd/core/base.py','nb_cmd/core/meta.py','nb_cmd/ui/helper.py',
           
        ],
    )
    .auto_merge_from_python_project_some_files()
    .merge_from_files(
        relative_file_name_list=['nb_cmd_vs_click_vs_typer.md'],
        as_title='nb_cmd 和其他顶流命令行框架例如click typer fire对比'
    )
    .merge_from_dir(
