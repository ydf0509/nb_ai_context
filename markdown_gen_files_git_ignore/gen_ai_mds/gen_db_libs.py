...
ai_md = AiMdGenerator(r"D:\codes\nb_ai_context\markdown_gen_files_git_ignore\ai_md_files\db_libs_all_docs_and_codes.md")
...
(
        ...
        .merge_from_files(
            ...
            project_root=r"D:\codes\db_libs",
            as_title="db_libs readme",
        )
        .merge_from_dir(
            project_root=r"D:\codes\db_libs",
            relative_dir_name="db_libs",
            use_gitignore=True,
            as_title="db_libs codes",
            # 只包含 .py 和 .md 文件
